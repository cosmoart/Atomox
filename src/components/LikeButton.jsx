		...
		<>
			<SignedIn>
				<button
					disabled={pending}
					onClick={handleLike}
					className={`relative flex items-center gap-0.5 justify-center group/like  not-disabled:cursor-pointer`}
				>
					<span className='relative size-[22px] transition-all group-not-disabled/like:group-hover/like:scale-110  group-not-disabled/like:group-active/like:scale-90'>
