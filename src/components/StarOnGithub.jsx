...
export default function StarOnGitHub () {
	...
	return (
		<a
			...
			className='rounded-full text-sm active:scale-95 px-4 py-0.5 btn-primary gradient1 border-white/10 border group drop-shadow-sm flex gap-1 items-center text-white w-fit group grow-x origin-left'
