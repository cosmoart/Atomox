...
export default function Error ({ error }) {
	return (
		<main className='text-center min-h-svh flex justify-center items-center flex-col'>
			...
			<Link href='/' className='btn btn-primary mt-3 py-1.5 flex gap-1 px-8 pr-10 group shining 2xl:text-lg items-center gradient1'>
