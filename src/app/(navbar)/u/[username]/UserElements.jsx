...
export default function UserElements ({ username, isAuthor }) {
	...
	if (elements.length === 0) return <div className="pb-4 mt-8">
		<div className='py-10 flex items-center  gap-4 flex-col'>
			...
			{
				isAuthor && <Link href='/create' className='px-7 py-1.5 rounded-lg btn-primary text-[15px] tracking-wide font-medium cursor-pointer hover:scale-x-105 shining gradient1'>Create one</Link>
			}
		</div>
	</div>
