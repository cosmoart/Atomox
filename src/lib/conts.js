...
export const Atoms = [
	...
	},
	{
		name: 'Pagination ',
		id: 'pagination',
		description: 'A pagination is a set of links that allow users to navigate through a collection of items.',
		icon: atomsIcons.pagination,
		html: atomsCode.pagination.html,
		htmlTailwind: atomsCode.pagination.htmlTailwind,
		css: atomsCode.pagination.css,
		js: atomsCode.pagination.js,
	},
];
